...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary pt-3 sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: none; background-color: black;">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex mb-4 align-items-center justifygr-content-center" href="admin-home">
        <!-- <div class="sidebar-brand-icon rotate-n-15"> -->
        <div class="sidebar-brand-icon">
          <!-- <i class="fas fa-laugh-wink"></i> -->
          <img src="../img/zoo.png" alt="" style="width: 75px; border-radius: 20%">
        </div>
        <div class="sidebar-brand-text mx-3">SKRD Admin Panel</div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; <?php echo date('Y')?> - Designed and Developed by: Sean Kobe R. Dime</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
