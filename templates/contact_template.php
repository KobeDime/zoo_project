<section class="py-5 bg-cover bg-gray">
    <div class="container py-5">
        ...
        <p class="lead my-4">Get in touch with us! We are here to help you with any inquiries or support you may need. Reach out to us and we'll get back to you as soon as possible.</p>
    </div>
</section>
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <p class="text-muted mb-0 text-small">1118 Novaliches</p>
                        <p class="text-muted mb-0 text-small">Philippines <strong>Manila </strong></p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
                        <div class="icon mb-4"><i class="pe-7s-phone"></i></div>
                        <h5 class="lined mb-4">Call Center</h5>
                        <p class="text-muted mb-3 text-small">If you have any questions or need assistance, our call center is here to help. Feel free to reach out to us.</p>
                        <p class="text-muted font-weight-bold">+63 976 8181</p>
                    </div>
                    <div class="col-lg-12 col-md-6 mb-4">
                        ...
                        <ul>
                            <li><a href="#" class="font-weight-bold text-small">kobe24.dime@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
