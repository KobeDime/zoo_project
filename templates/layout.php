...
<head>
  ...
  <!-- Favicon-->
  <link rel="shortcut icon" href="../img/zoo.png">
      ...
      <div class="container-fluid">
        <a href="home" class="navbar-brand font-weight-bold p-0">
          <div class="d-flex align-items-center">
            <div>
              <img src="../img/zoo.png" width="120" style="border-radius: 100%" />
            </div>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          <h5 class="lined lined-dark color-header mb-3 color-header">About Kobe Safari</h5>
          <p class="text-muted text-small">Welcome to Kobe Safari, where the wild meets the wonderful! Our zoo management system is designed to bring the essence of the animal kingdom right to your fingertips. Just as a safari journey takes you through diverse landscapes and habitats, Kobe Safari guides you through the intricate world of zoo management with ease and efficiency.</p>
          <p class="text-muted text-small">Inspired by the seamless flow of nature, Kobe Safari ensures that every aspect of managing a zoo—from animal care to visitor interactions—is as smooth and intuitive as a walk through the savannah. Our system leverages modern technology to provide a comprehensive tool for tracking animal well-being, coordinating staff schedules, and enhancing the visitor experience.</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Our Location</h5>
          <h6>Kobe Safari</h6>
          <p class="text-muted mb-0 text-small">27th Street, Kobe Safari</p>
          <p class="text-muted mb-0 text-small">Philippines, 1118</p>
          <p class="text-muted mb-4 text-small">Mobile + 63 976 921 8181 </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">My Other Projects</h5>
          <ul class="list-unstyled">
            <li><a href="#" class="footer-link text-small">E-Commerce Management System</a></li>
            <li><a href="#" class="footer-link text-small">Tourism Management System</a></li>
            <li><a href="#" class="footer-link text-small">Hotel Management System</a></li>
            <li><a href="#" class="footer-link text-small">Library Management System</a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="lined lined-dark mb-3 color-header">Connect with us</h5>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="https://www.facebook.com/ohitskobe" class="social-link facebook-logo"><i class="fab fa-facebook-f"></i></a></li>
            <li class="list-inline-item"><a href="https://www.instagram.com/ohitskobe_/?hl=en" class="social-link instagram-logo"><i class="fab fa-instagram"></i></a></li>
            <li class="list-inline-item"><a href="https://x.com/kobeatom_" class="social-link twitter-logo"><i class="fab fa-twitter"></i></a></li>
            <li class="list-inline-item"><a href="mailto:kobe24.dime@gmail.com" class="social-link mail-logo"><i class="fas fa-envelope"></i></a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-md-6">
          <h5 class="lined lined-dark mb-3 color-header">Contact Us</h5>
          <p class="text-muted mb-4 text-small">Your experience matters to us! For questions or assistance, use the form on our Contact Us page. Whether it’s about animal care, 
            visiting hours, or anything else, we’re here to help. We look forward to making your visit to our zoo unforgettable!
          </p>
        </div>
      </div>
    </div>
    <div class="bg-header py-2 text-center text-white">
      <p class="p-0 m-0">&copy; <?php echo date('Y'); ?> - Designed and Developed by: 
          <a href="https://seankobedime.netlify.app/" class="text-white" target="_blank" rel="noopener noreferrer">Sean Kobe R. Dime</a>
      </p>
    </div>
  </footer>
  <!-- JavaScript files-->
